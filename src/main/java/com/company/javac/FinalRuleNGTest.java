...
public class FinalRuleNGTest {
    ...
    public void testSimpleFieldRegExp() throws Exception {
        RuleTest.create()
                .input("com.company.javac/JsonFormat.java",
                       "package com.company.javac;\n" +
                ...
                .assertWarnings("\"/com/company/javac/JsonFormat.java:121-124: Unclosed group.");
    }
    ...
    public void testNotAllowedImplementor() throws Exception {
        RuleTest.create()
                ...
                .assertWarning("/com/company/javac/JsonFormat.java:14-50:Cannot implement: test.API, not its listed implementor.");
    }
}
*/
